...
import keypressAudioFile from '@/assets/sounds/keypress.flac'
import keyreleaseAudioFile from '@/assets/sounds/keyrelease.flac'

// import keySets from './steno-script'
import { useSound } from './hooks/use-sound.mjs'
import useStrokeEvents from './hooks/use-stroke-events.mjs'
import useUrlParam from './hooks/use-url-param.mjs'
import usePrevious from './hooks/usePrevious.mjs'
import useWakeLock from './hooks/useWakeLock.mjs'
...
import { convertLookupStrokeToKeysSequence, LookupStateEnum } from './utils/lookup.mjs'
import { dep, getAddedAndRemovedItems } from './utils/tools.mjs'
